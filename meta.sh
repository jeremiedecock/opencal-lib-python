...
COPYRIGHT_NOTICE="Copyright (c) 2008-2019 ${AUTHOR_NAME} (${AUTHOR_WEB_SITE})"

PROJECT_INITIAL_DATE="2008-07-22"
PROJECT_SHORT_DESC="OpenCAL core library for Python"

PROJECT_NAME="OpenCAL"
PYTHON_PACKAGE_NAME="opencal-lib-py"

PROJECT_GITHUB_ACCOUNT="jdhp"
PROJECT_GITHUB_REPOSITORY_NAME="opencal-lib-python"
